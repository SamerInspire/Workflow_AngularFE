...
export class EditWorkflowComponent {
  @ViewChild(WorkflowDesignerComponent)
  workflowDesigner?: WorkflowDesignerComponent = undefined;
  ...
  constructor(private route: ActivatedRoute) {
    ...
    route.params.subscribe((params) => {
      ...
      me.detials = params["detials"];
    });
    console.log("detials ===> ", me.detials);
  }
  ...
  upload() {
    ...
    var uploadCallback = function () {
      ...
      var form = window.document.getElementById(
        me.designerConfig.uploadFormId
      ) as HTMLFormElement;
