...
export class WorkflowSchemeServiceProxy {
  ...
  executeCommand(
    ...
    let url_ =
      this.baseUrl + "/api/services/app/WorkflowScheme/ExecuteCommand?";
  ...
  protected processExecuteCommand(
    response: HttpResponseBase
  ): Observable<boolean> {
    const status = response.status;
    const responseBlob =
  ...
  getAvaliableCommands(
    processId: string | null | undefined
  ): Observable<WorkflowCommandDto[]> {
    let url_ =
      this.baseUrl + "/api/services/app/WorkflowScheme/GetAvaliableCommands?";
    if (processId !== undefined)
      url_ += "processId=" + encodeURIComponent("" + processId) + "&";
    url_ = url_.replace(/[?&]$/, "");
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<WorkflowCommandDto[]>>(
                (<any>_observableThrow(e))
              );
            }
          } else
  ...
  protected processGetAvaliableCommands(
    response: HttpResponseBase
  ): Observable<WorkflowCommandDto[]> {
    const status = response.status;
    const responseBlob =
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<GetWorkflowSchemesOutput>>(
                (<any>_observableThrow(e))
              );
            }
          } else
  ...
  protected processGetSchemes(
    response: HttpResponseBase
  ): Observable<GetWorkflowSchemesOutput> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
      ...
      return blobToText(responseBlob).pipe(
        _observableMergeMap((_responseText) => {
          ...
          result200 = resultData200
            ? GetWorkflowSchemesOutput.fromJS(resultData200)
            : new GetWorkflowSchemesOutput();
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<WorkflowHistoryDto[]>>(
                (<any>_observableThrow(e))
              );
            }
          } else
...
export class DocumentServiceProxy {
        ...
        _observableMergeMap((_responseText) => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? DocumentDto.fromJS(resultData200)
            : new DocumentDto();
          return _observableOf(result200);
        })
      );
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<SchemeForDocumentOutput[]>>(
                (<any>_observableThrow(e))
              );
            }
          } else
  ...
  protected processGetSchemes(
    response: HttpResponseBase
  ): Observable<SchemeForDocumentOutput[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
  ...
  ): Observable<PagedResultDtoOfDocumentDto> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<PagedResultDtoOfDocumentDto>>(
                (<any>_observableThrow(e))
              );
            }
          } else
        ...
        _observableMergeMap((_responseText) => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? PagedResultDtoOfDocumentDto.fromJS(resultData200)
            : new PagedResultDtoOfDocumentDto();
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
...
export class GetWorkflowSchemesOutput implements IGetWorkflowSchemesOutput {
  ...
  toJSON(data?: any) {
    ...
    if (this.schemes && this.schemes.constructor === Array) {
      data["schemes"] = [];
      for (let item of this.schemes) data["schemes"].push(item.toJSON());
    }
    data["id"] = this.id;
    return data;
  }
...
export class WorkflowSchemeDto implements IWorkflowSchemeDto {
  ...
  name: string | undefined;
  description: string | undefined;
  businessFunctionList: string | undefined;
  accessLink: string | undefined;
  category: string | undefined;
  applicationVersion: string | undefined;
  applicationClassification: string | undefined;
  itApplicationType: string | undefined;
  businessApplicationType: string | undefined;
  businessServiceCode: string | undefined;
  businessActivityCode: string | undefined;
  businessCriticality: string | undefined;
  targetUser: string | undefined;
  businessOwner: string | undefined;
  serverCatalogCode: string | undefined;
  hostType: string | undefined;
  hostCenter: string | undefined;
  ...
  init(data?: any) {
    if (data) {
      ...
      this.businessFunctionList = data["businessFunctionList"];
      this.accessLink = data["accessLink"];
      this.category = data["category"];
      this.applicationVersion = data["applicationVersion"];
      this.applicationClassification = data["applicationClassification"];
      this.itApplicationType = data["itApplicationType"];
      this.businessApplicationType = data["businessApplicationType"];
      this.businessServiceCode = data["businessServiceCode"];
      this.businessActivityCode = data["businessActivityCode"];
      this.businessCriticality = data["businessCriticality"];
      this.targetUser = data["targetUser"];
      this.businessOwner = data["businessOwner"];
      this.serverCatalogCode = data["serverCatalogCode"];
      this.hostType = data["hostType"];
      this.hostCenter = data["hostCenter"];
  ...
  toJSON(data?: any) {
    data = typeof data === "object" ? data : {};
    data["code"] = this.code;
    data["details"]["name"] = this.name;
    data["details"]["description"] = this.description;
    data["details"]["businessFunctionList"] = this.businessFunctionList;
    data["details"]["accessLink"] = this.accessLink;
    data["details"]["category"] = this.category;
    data["details"]["applicationVersion"] = this.applicationVersion;
    data["details"]["applicationClassification"] = this.applicationClassification;
    data["details"]["itApplicationType"] = this.itApplicationType;
    data["details"]["businessApplicationType"] = this.businessApplicationType;
    data["details"]["businessServiceCode"] = this.businessServiceCode;
    data["details"]["businessActivityCode"] = this.businessActivityCode;
    data["details"]["businessCriticality"] = this.businessCriticality;
    data["details"]["targetUser"] = this.targetUser;
    data["details"]["businessOwner"] = this.businessOwner;
    data["details"]["serverCatalogCode"] = this.serverCatalogCode;
    data["details"]["hostType"] = this.hostType;
    data["details"]["hostCenter"] = this.hostCenter;
    data["details"]["hostIP"] = this.hostIP;
    data["details"]["public"] = this.public;
    return data;
  }
...
export class WorkflowHistoryDto implements IWorkflowHistoryDto {
  ...
  init(data?: any) {
    if (data) {
      ...
      this.transitionTime = data["transitionTime"]
        ? moment(data["transitionTime"].toString())
        : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    data["transitionTime"] = this.transitionTime
      ? this.transitionTime.toISOString()
      : <any>undefined;
...
export class SchemeForDocumentOutput implements ISchemeForDocumentOutput {
  ...
  toJSON(data?: any) {
    ...
    if (this.commands && this.commands.constructor === Array) {
      data["commands"] = [];
      for (let item of this.commands) data["commands"].push(item.toJSON());
    }
    return data;
  }
...
export class SchemeForDocumentCommandOutput
  implements ISchemeForDocumentCommandOutput
{
  name: string | undefined;
  localizedName: string | undefined;
  classifier: string | undefined;
...
export class PagedResultDtoOfDocumentDto
  implements IPagedResultDtoOfDocumentDto
{
